...
<head>
<meta charset="UTF-8">
<title>DIGIPUS Admin Dashboard</title>
...
<div class="hero">
  ...
  <p>Kelola buku, peminjaman, dan petugas dengan mudah</p>
</div>
...
@php
  $returnedBooks = collect($peminjamans)->where('status', 'returned')->count();
@endphp
...
<div class="section">
  <div class="no-print" style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
    ...
    <a href="{{ route('admin.denda.index') }}" class="btn btn-sm">
...
<script src="{{ asset('js/admin-dasbor.js') }}"></script>
